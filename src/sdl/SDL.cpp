...
int main(int argc, char** argv)
{
  ...
  inputSetKeymap(PAD_2, KEY_P2_LEFT, ReadPrefHex("Joy1_P2_Left"));
  inputSetKeymap(PAD_2, KEY_P2_RIGHT, ReadPrefHex("Joy1_P2_Right"));
  inputSetKeymap(PAD_2, KEY_P2_UP, ReadPrefHex("Joy1_P2_Up"));
  inputSetKeymap(PAD_2, KEY_P2_DOWN, ReadPrefHex("Joy1_P2_Down"));
  inputSetKeymap(PAD_2, KEY_P2_BUTTON_A, ReadPrefHex("Joy1_P2_A"));
  inputSetKeymap(PAD_2, KEY_P2_BUTTON_B, ReadPrefHex("Joy1_P2_B"));
  inputSetKeymap(PAD_2, KEY_P2_BUTTON_L, ReadPrefHex("Joy1_P2_L"));
  inputSetKeymap(PAD_2, KEY_P2_BUTTON_R, ReadPrefHex("Joy1_P2_R"));
  inputSetKeymap(PAD_2, KEY_P2_BUTTON_START, ReadPrefHex("Joy1_P2_Start"));
  inputSetKeymap(PAD_2, KEY_P2_BUTTON_SELECT, ReadPrefHex("Joy1_P2_Select"));
  ...
  inputSetKeymap(PAD_3, KEY_P2_LEFT, ReadPrefHex("Joy2_P2_Left"));
  inputSetKeymap(PAD_3, KEY_P2_RIGHT, ReadPrefHex("Joy2_P2_Right"));
  inputSetKeymap(PAD_3, KEY_P2_UP, ReadPrefHex("Joy2_P2_Up"));
  inputSetKeymap(PAD_3, KEY_P2_DOWN, ReadPrefHex("Joy2_P2_Down"));
  inputSetKeymap(PAD_3, KEY_P2_BUTTON_A, ReadPrefHex("Joy2_P2_A"));
  inputSetKeymap(PAD_3, KEY_P2_BUTTON_B, ReadPrefHex("Joy2_P2_B"));
  inputSetKeymap(PAD_3, KEY_P2_BUTTON_L, ReadPrefHex("Joy2_P2_L"));
  inputSetKeymap(PAD_3, KEY_P2_BUTTON_R, ReadPrefHex("Joy2_P2_R"));
  inputSetKeymap(PAD_3, KEY_P2_BUTTON_START, ReadPrefHex("Joy2_P2_Start"));
  inputSetKeymap(PAD_3, KEY_P2_BUTTON_SELECT, ReadPrefHex("Joy2_P2_Select"));
  ...
  inputSetKeymap(PAD_4, KEY_P2_LEFT, ReadPrefHex("Joy3_P2_Left"));
  inputSetKeymap(PAD_4, KEY_P2_RIGHT, ReadPrefHex("Joy3_P2_Right"));
  inputSetKeymap(PAD_4, KEY_P2_UP, ReadPrefHex("Joy3_P2_Up"));
  inputSetKeymap(PAD_4, KEY_P2_DOWN, ReadPrefHex("Joy3_P2_Down"));
  inputSetKeymap(PAD_4, KEY_P2_BUTTON_A, ReadPrefHex("Joy3_P2_A"));
  inputSetKeymap(PAD_4, KEY_P2_BUTTON_B, ReadPrefHex("Joy3_P2_B"));
  inputSetKeymap(PAD_4, KEY_P2_BUTTON_L, ReadPrefHex("Joy3_P2_L"));
  inputSetKeymap(PAD_4, KEY_P2_BUTTON_R, ReadPrefHex("Joy3_P2_R"));
  inputSetKeymap(PAD_4, KEY_P2_BUTTON_START, ReadPrefHex("Joy3_P2_Start"));
  inputSetKeymap(PAD_4, KEY_P2_BUTTON_SELECT, ReadPrefHex("Joy3_P2_Select"));
