...
enum {
  ...
  KEY_BUTTON_GS,
  KEY_P2_LEFT, KEY_P2_RIGHT,
  KEY_P2_UP, KEY_P2_DOWN,
  KEY_P2_BUTTON_A, KEY_P2_BUTTON_B,
  KEY_P2_BUTTON_START, KEY_P2_BUTTON_SELECT,
  KEY_P2_BUTTON_L, KEY_P2_BUTTON_R
};
